...
function addon.StartMinimap(picker)
    ...
    local function Build()
        ...
        -- Native tank shield: UnitFrameUtil / GetTexCoordsForOldRoleSmallCircle (Forever70009).
        button.icon:SetTexture("Interface\\LFGFrame\\UI-LFG-ICON-PORTRAITROLES")
        button.icon:SetTexCoord(0, 19/64, 22/64, 41/64)
